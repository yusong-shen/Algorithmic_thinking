...
def slow_closest_pairs(cluster_list):
    ...
    # idx1 < idx2
    closest_pairs = [(-inf,-1,-1)]
    for idx1 in range(cluster_list):
        for idx2 in range(cluster_list):
            if idx1 < idx2:
                dist = pair_distance(cluster_list, idx1, idx2)
                if dist < closest_pair[0][0]:
                    closest_pairs = [(dist, idx1, idx2)]
                elif dist == closest_pair[0][0]:
...
def test():
    """
    test cases for alg_project3 closest pair and clustering
    """
    return