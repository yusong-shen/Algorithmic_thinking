...
pam50_scoring_dict = provided.read_scoring_matrix(PAM50)
human_protein_seq = provided.read_protein(HUMAN_EYELESS)
fruitfly_protein_seq = provided.read_protein(FRUITFLY_EYELESS)
...
(score, align_x, align_y) = compute_local_alignment(human_protein_seq, fruitfly_protein_seq, 
